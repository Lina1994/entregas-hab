class ListOfTodos {
  ...
  attachEvents() {
    ...
    // Cuando se pulse el boton de limpiar tareas ejecute el método cleanListOfTodos
    this.cleanButton.addEventListener("click", (e) => {
      this.cleanListOfTodos();
    });
...
// Instancio la clase!
const myTodos = new ListOfTodos(form, list, "stored-todos");
